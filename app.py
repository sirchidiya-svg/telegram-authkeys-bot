...
async def subscribe_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Placeholder subscription entry point (wire this up to Telegram Stars payments)."""
    await update.message.reply_text(
        "💫 Subscribe for 30 days of unlimited use!\n"
        "Payments via Telegram Stars are coming soon — stay tuned.\n\n"
        "Once payment is added, a successful purchase will call grant_subscription() "
        "for your account."
    )
